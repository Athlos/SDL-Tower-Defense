...
pause menu ->ESC
start wave ->SPACE
click on either wall or tower icon to select a wall or tower in the "Building" section. Click to place building on map.
click on enemies to damage them.
...
Place walls to block the enemy path. Place towers to shoot the enemy. You can also click on enemies to shoot them for 1 damage.
